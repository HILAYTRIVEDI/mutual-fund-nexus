            ...
            <main className="flex-1 min-w-0">
                ...
                <div className="flex gap-2 mb-6 p-1 bg-[var(--bg-hover)]/50 rounded-xl w-fit border border-[var(--border-primary)]">
                    <button
                        ...
                        className={`px-4 md:px-6 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 flex items-center gap-2 ${activeCalculator === 'sip'
                    ...
                    <button
                        ...
                        className={`px-4 md:px-6 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 flex items-center gap-2 ${activeCalculator === 'lumpsum'
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex items-center gap-1 bg-[var(--bg-hover)] px-3 py-1.5 rounded-lg border border-[var(--border-primary)]">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (activeCalculator === 'sip') setSipAmount(val); else setLumpsumAmount(val);
                                            }}
                                    ...
                                    <div className="flex items-center gap-1 bg-[var(--bg-hover)] px-3 py-1.5 rounded-lg border border-[var(--border-primary)]">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (activeCalculator === 'sip') setSipRate(val); else setLumpsumRate(val);
                                            }}
                                    ...
                                    <div className="flex items-center gap-1 bg-[var(--bg-hover)] px-3 py-1.5 rounded-lg border border-[var(--border-primary)]">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (activeCalculator === 'sip') setSipTenure(val); else setLumpsumTenure(val);
                                            }}
                    ...
                    <div className="glass-card rounded-2xl p-5 md:p-6 relative overflow-hidden">
                        {/* Gradient Overlay */}
                        <div className={`absolute inset-0 bg-gradient-to-br ${activeCalculator === 'sip'
                        ...
                        <div className="text-center mb-8 relative z-10">
                            ...
                            <p className={`text-4xl md:text-5xl font-bold ${activeCalculator === 'sip' ? 'text-[var(--accent-mint)]' : 'text-[var(--accent-purple)]'
                                }`}>
                        ...
                        <div className="grid grid-cols-2 gap-3 relative z-10">
                            ...
                            <div className="p-3 rounded-xl bg-[var(--bg-hover)]/50 border border-[var(--border-primary)]">
                                ...
                                <p className={`font-bold text-base ${activeCalculator === 'sip' ? 'text-[var(--accent-mint)]' : 'text-[var(--accent-purple)]'
                                    }`}>
                        ...
                        <div className="mt-6 relative z-10">
                            <div className="flex gap-1 h-4 rounded-full overflow-hidden">
                                ...
                                />
                                <div
                                    className={`${activeCalculator === 'sip' ? 'bg-[var(--accent-mint)]' : 'bg-[var(--accent-purple)]'
                            ...
                            <div className="flex justify-between mt-2 text-[10px]">
                                ...
                                <div className="flex items-center gap-1.5">
                                    <div className={`w-2.5 h-2.5 rounded-full ${activeCalculator === 'sip' ? 'bg-[var(--accent-mint)]' : 'bg-[var(--accent-purple)]'
                                        }`} />
